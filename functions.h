...
//#define COOLER_ON_BARRIER         28   //порог температуры включения кондиционера
//#define COOLER_OFF_BARRIER        22 //порог температуры выключения кондиционера
...
#define STATE_DHT_ERROR_UNBOUND   110     //ошибка датчика. Связь есть но он показывает фигню (выход за пределы диапазона измерений) 
